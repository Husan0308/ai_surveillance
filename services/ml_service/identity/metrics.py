...
class IdentityMetricValues:
    ...
    ambiguous_matches:int=0; identity_conflicts:int=0; identity_switch_suspected:int=0
...
class IdentityMetrics:
    ...
    def format_compact(self):
        m=self.snapshot();return (f"IDENTITY\nactive_global:{m['global_identities_active']} total:{m['global_identities_total']} "
            f"new:{m['new_identities']} recovered:{m['recovered_identities']} ambiguous:{m['ambiguous_matches']} conflicts:{m['identity_conflicts']}\n"
