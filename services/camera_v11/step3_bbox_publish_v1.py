...
class V11Step3BboxPublisherV1(V11Step3TrackingV2):
    ...
    def __init__(self) -> None:
        ...
        self.single_target = SingleTargetBboxLockV1(
            SingleTargetLockConfigV1(
                ...
                min_hits=int(os.environ.get("V11_BBOX_LOCK_MIN_HITS", "2")),
    ...
    def _consume_tracking(self, cid: str, boxes: list[list[float]], captured_ns: int) -> None:
        # Deliberately mirrors frozen Step3 bookkeeping. Detector and tracker
        # outputs remain untouched. The single-target gate only decides which
        # already-computed local bbox is allowed onto the debug display.
