...
LOG="${V11_BBOX_NVDCF_LOG:-/tmp/CAMERA_V11_BBOX_NVDCF_CAM01_CAM02_CAM03.log}"
APP_PY="${V11_DS_YOLO_PYTHON:-$HOME/ai_surveillance/.venv/bin/python}"
[[ -x "$APP_PY" ]] || APP_PY="$(command -v python3)"
fail(){ printf 'V11_BBOX_NVDCF_CAM01_CAM02_CAM03_PREFLIGHT RESULT=FAIL reason=%s\n' "$*" >&2; exit 1; }
...
export V11_DS_YOLO_CAMERAS="CAM-01,CAM-02,CAM-03"
export V11_UI_PREVIEW_CAMERAS="CAM-01,CAM-02,CAM-03"
...
export V11_BBOX_TRACK_CAMERAS="CAM-01,CAM-02,CAM-03"
# Keep the physically accepted CAM-01/CAM-02 profile unchanged for the CAM-03 rollout.
