...
echo "SENTINEL_BUILD branch=${BRANCH} head=${HEAD_SHA} expected_ui=2026.08.20-r15-monitoring-recovery"
...
# Hardware measurements on the deployment GTX 1050 Ti selected 672x384/batch=1:
# 72.7 ms avg (~13.76 images/s), faster than both 736x416 and 640x352.
...
echo "SENTINEL_PROFILE inherited_mux=${INHERITED_MUX} inherited_detector=${INHERITED_DETECT} inherited_tracker=${INHERITED_TRACKER} effective_mux=2560x1440 focus=1920x1080 detector=RF-DETR-S@672x384 threshold=0.18 batch=1 tracker=NvDCF@512x288 display_box=adaptive-8/4/10"
