...
print("ML_SUBSTREAM_IMPORTS status=OK demand_latched_ready_first=1 live_preroll_safe=1", flush=True)
PY
...
printf '%s\n' \
  ...
  "ML_SUBSTREAM_BOUNDARY main_stream=0 camera_service_shm=0 tracker=0 api=0 ui=0 sparse_gate_before_convert=1 scheduler=demand-latched-ready-first blocking_capture_wait=0 demand_poll=${ML_SUBSTREAM_DEMAND_POLL_MS}ms"
