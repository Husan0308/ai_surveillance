...
`cluster-mode=2`, `nms-iou-threshold=0.45`, and
...
camera/frame. It records pairs above IoU 0.45, pairs at or above 0.90 and 0.95,
...
active retry threshold is now 0.45, while confidence remains 0.25. This change
